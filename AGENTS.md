...
This repo has two layers: the outer repo (the cookiecutter template project itself) and the generated project (inside `{{cookiecutter.package_name}}/`). They share similar patterns for pyproject.toml, justfile, CI workflows, etc.
